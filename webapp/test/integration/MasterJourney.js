sap.ui.define([
	...
	opaTest("MasterList Filtering on UnitsInStock less than 100", function(Given, When, Then) {

		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
		and.iSelectListItemInViewSettingsDialog("UnitsInStock").
		and.iSelectListItemInViewSettingsDialog("<100 QuantityPerUnit").
	...
	opaTest("MasterList Filtering on UnitsInStock more than 100", function(Given, When, Then) {
		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
		and.iSelectListItemInViewSettingsDialog(">100 QuantityPerUnit").
		and.iPressOKInViewSelectionDialog();
